...
/* LES DONNÉES LONGUES — une seule copie, lue par sonde-appareils.js et audit-profond.js (LONGUES=1).
   Les données de démonstration sont COURTES (« 0h00 », « Client de test 3 ») et flattent toute
   mise en page : on pose les valeurs les plus longues plausibles avant de parcourir. */
const DONNEES_LONGUES = `const NOM='Établissements Hospitaliers Universitaires de la Côte-Saint-Laurent';
...
module.exports = { PROFILS, profil, poserProfil, DONNEES_LONGUES };
