...
- **Une proposition « aux couleurs du logo »** — Justin, logo à l'appui : « montre-moi un thème avec ce
  style en couleur du logo, mais ne l'applique pas, je veux le voir ». Ce qu'elle change : l'en-tête de
  l'accueil devient la tuile du logo (coupe en diagonale menthe / forêt, et le titre change de couleur
  en la traversant, comme le « OP ») ; la date en sauge ; la barre d'onglets en vert forêt, bulle
  menthe ; les tuiles d'icône dans les deux verts du logo ; la nuit en verts forêt. Captures envoyées
  (iPhone et Mac, jour et nuit). ⛔ **MISE DE CÔTÉ PAR JUSTIN le 25 septembre 2026 : « Non, seulement
  les 2 »** — l'écran « Thème et couleur » garde TEAM OP (par défaut) et OP GESTION. Elle a été le
  troisième thème de la bêta le temps d'une matinée (v747, jamais publiée), éprouvée (`test-807`
  61 ✓, 24/24 mutations ; `sonde-logo` 56 ✓) : cette version complète vit dans les commits `839aa87`
  et `a460a67`, et c'est de là qu'on repart s'il la rouvre. La maquette est rangée, non appliquée,
  dans `design/propositions/theme-logo.css`.
