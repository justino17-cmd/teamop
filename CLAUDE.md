...
**94 suites dans `tests/`**, sans dépendance ni installation (recompté le 20 septembre 2026 —
...
```bash
bash scripts/bancs-ci.sh        # 94 suites · 3 851 vérifications (mesuré le 20/09/2026, nuit)
