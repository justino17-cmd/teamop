...
**177 suites dans `tests/`**, sans dépendance ni installation (recompté le 26 septembre 2026, `test-821` compris —
...
```bash
bash scripts/bancs-ci.sh        # 177 suites · 8 724 vérifications (mesuré en local le 26/09/2026, v753)
