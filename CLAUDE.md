...
**150 suites dans `tests/`**, sans dépendance ni installation (recompté le 23 septembre 2026 dans la nuit —
...
```bash
bash scripts/bancs-ci.sh        # 150 suites · 7 091 vérifications (mesuré le 23/09/2026, v740)
