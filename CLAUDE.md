...
**176 suites dans `tests/`**, sans dépendance ni installation (recompté le 26 septembre 2026, `test-820` compris —
...
```bash
bash scripts/bancs-ci.sh        # 176 suites · 8 657 vérifications (mesuré en local le 26/09/2026, v752)
