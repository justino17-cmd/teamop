...
**143 suites dans `tests/`**, sans dépendance ni installation (recompté le 23 septembre 2026 au soir —
...
```bash
bash scripts/bancs-ci.sh        # 143 suites · 6 563 vérifications (mesuré le 23/09/2026, v735)
