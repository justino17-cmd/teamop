...
**139 suites dans `tests/`**, sans dépendance ni installation (recompté le 23 septembre 2026 —
...
```bash
bash scripts/bancs-ci.sh        # 139 suites · 6 351 vérifications (mesuré le 23/09/2026, v733)
