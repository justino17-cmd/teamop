...
**178 suites dans `tests/`**, sans dépendance ni installation (recompté le 26 septembre 2026, `test-822` compris —
...
```bash
bash scripts/bancs-ci.sh        # 178 suites · 8 767 vérifications (mesuré en local le 26/09/2026, v755)
