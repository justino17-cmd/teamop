...
**164 suites dans `tests/`**, sans dépendance ni installation (recompté le 25 septembre 2026, `test-808` compris —
...
```bash
bash scripts/bancs-ci.sh        # 164 suites · 8 127 vérifications (mesuré en local le 25/09/2026, v747)
